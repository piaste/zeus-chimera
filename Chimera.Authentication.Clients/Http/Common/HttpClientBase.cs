...
namespace ZenProgramming.Chimera.Common.Client.Http
{
    /// <summary>
    /// Base HTTP client for remove invokes
    /// </summary>
            ...
            where TResponse : class, new()
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    {
                        //Traccio l'eccezione JSON
                        Tracer.Warn("JSON deserialization exception: {0}\n" +
                            "Request URL: {1}\n" +
                            "Source JSON Data : {2}\n" +
                            "Request body : {3}",
                            jsonException,
